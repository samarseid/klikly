...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    "investment.kicker": "Investment",
    "investment.title": "Raising $100,000",
    "investment.subtitle":
      "A focused seed round to launch Klikly in Tashkent and prove the playbook before regional expansion.",
    "investment.amount": "$100,000",
    "investment.amountLabel": "Target round",
    "investment.reserveLabel": "+10% reserve buffer per category",
    "investment.alloc.0.label": "Development",
    "investment.alloc.0.percent": "40%",
    "investment.alloc.0.amount": "$40,000",
    "investment.alloc.0.desc": "Engineering, AI infrastructure, mobile apps, escrow integration.",
    "investment.alloc.1.label": "Marketing",
    "investment.alloc.1.percent": "30%",
    "investment.alloc.1.amount": "$30,000",
    "investment.alloc.1.desc": "Performance ads, brand, partnerships, launch campaigns.",
    "investment.alloc.2.label": "Team",
    "investment.alloc.2.percent": "20%",
    "investment.alloc.2.amount": "$20,000",
    "investment.alloc.2.desc": "Core hires across product, engineering, and operations.",
    "investment.alloc.3.label": "Operations",
    "investment.alloc.3.percent": "10%",
    "investment.alloc.3.amount": "$10,000",
    "investment.alloc.3.desc": "Legal, licenses, infrastructure, day-to-day runway.",
    "investment.reserve.title": "Contingency reserve",
    "investment.reserve.desc":
      "An additional 10% buffer is allocated on top of every category — so we ship even if reality moves faster than the plan.",
  ...
  uz: {
    ...
    "hero.stat2": "Tekshirilgan xizmatchilar",
    ...
    "problem.list.2.title": "Ischilar uchun mas’uliyat yo‘q",
    "problem.list.2.body":
    ...
    "roadmap.1.tag": "Hozir",
    "roadmap.2.title": "MVP",
    "roadmap.2.body": "Toshkentda beta — tasdiqlangan e’lonlar va 1,000 ishci.",
    "roadmap.2.tag": "3 oy",
    ...
    "investment.kicker": "Investitsiya",
    "investment.title": "$100,000 jalb qilinmoqda",
    "investment.subtitle":
      "Toshkentda Klikly’ni ishga tushirish va modelni isbotlash uchun aniq seed-raund.",
    "investment.amount": "$100,000",
    "investment.amountLabel": "Maqsadli raund",
    "investment.reserveLabel": "Har bir yo‘nalish uchun +10% zaxira",
    "investment.alloc.0.label": "Dasturlash",
    "investment.alloc.0.percent": "40%",
    "investment.alloc.0.amount": "$40,000",
    "investment.alloc.0.desc": "Muhandislik, AI infratuzilma, mobil ilovalar, eskrow integratsiya.",
    "investment.alloc.1.label": "Marketing",
    "investment.alloc.1.percent": "30%",
    "investment.alloc.1.amount": "$30,000",
    "investment.alloc.1.desc": "Reklama, brending, hamkorlik, ishga tushirish kampaniyalari.",
    "investment.alloc.2.label": "Jamoa",
    "investment.alloc.2.percent": "20%",
    "investment.alloc.2.amount": "$20,000",
    "investment.alloc.2.desc": "Mahsulot, muhandislik va operatsiyalar bo‘yicha asosiy ishga olishlar.",
    "investment.alloc.3.label": "Operatsiyalar",
    "investment.alloc.3.percent": "10%",
    "investment.alloc.3.amount": "$10,000",
    "investment.alloc.3.desc": "Yuridik, litsenziyalar, infratuzilma, kundalik xarajatlar.",
    "investment.reserve.title": "Zaxira fond",
    "investment.reserve.desc":
      "Har bir yo‘nalish ustiga qo‘shimcha 10% zaxira ajratilgan — reja tezlashsa ham mahsulot yetkaziladi.",
    ...
    "chatbot.greeting":
      "Salom — men Klikly AI’man. Kvartira topish, ischi yollash, eskrow yoki ishga tushish rejalari haqida so‘rang.",
    "chatbot.q.0": "Chilonzor metrosi yaqinida $500 gacha 2 xonali toping",
    "chatbot.q.1": "Xizmatchi meni aldamasligiga qanday ishonch hosil qilasiz?",
  ...
  ru: {
    ...
    "investment.kicker": "Инвестиции",
    "investment.title": "Привлекаем $100,000",
    "investment.subtitle":
      "Сфокусированный seed-раунд, чтобы запустить Klikly в Ташкенте и доказать модель до региональной экспансии.",
    "investment.amount": "$100,000",
    "investment.amountLabel": "Целевой раунд",
    "investment.reserveLabel": "+10% резерва на каждую категорию",
    "investment.alloc.0.label": "Разработка",
    "investment.alloc.0.percent": "40%",
    "investment.alloc.0.amount": "$40,000",
    "investment.alloc.0.desc": "Инженерия, AI-инфраструктура, мобильные приложения, эскроу.",
    "investment.alloc.1.label": "Маркетинг",
    "investment.alloc.1.percent": "30%",
    "investment.alloc.1.amount": "$30,000",
    "investment.alloc.1.desc": "Performance-реклама, бренд, партнёрства, запуск.",
    "investment.alloc.2.label": "Команда",
    "investment.alloc.2.percent": "20%",
    "investment.alloc.2.amount": "$20,000",
    "investment.alloc.2.desc": "Ключевые найма в продукт, инженерию и операции.",
    "investment.alloc.3.label": "Операции",
    "investment.alloc.3.percent": "10%",
    "investment.alloc.3.amount": "$10,000",
    "investment.alloc.3.desc": "Юридическое, лицензии, инфраструктура, операционные расходы.",
    "investment.reserve.title": "Резервный фонд",
    "investment.reserve.desc":
      "Дополнительные 10% выделены поверх каждой категории — чтобы поставить продукт даже если реальность опередит план.",
